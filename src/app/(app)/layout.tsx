...
export default async function AppLayout({
  ...
  return (
    <div className="min-h-screen">
      ...
      <footer className="mx-auto max-w-4xl px-6 pb-[max(2rem,env(safe-area-inset-bottom))] pt-4">
        <div className="flex justify-center border-t border-neutral-900 pt-6">
          <a
            href="https://github.com/ivanvlam/pollon"
            target="_blank"
            rel="noopener noreferrer"
            className="group inline-flex items-center gap-2 rounded-full border border-neutral-800 px-3.5 py-1.5 text-xs text-neutral-500 transition hover:border-neutral-700 hover:text-neutral-300"
          >
            <svg
              viewBox="0 0 16 16"
              aria-hidden="true"
